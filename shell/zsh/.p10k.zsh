# Generated by Powerlevel10k configuration wizard on 2023-07-09 at 10:41 PDT.
...
# Show an apple to indicate that I'm on my local machine. It's red or
# green based on the success of the last command.
#
# https://zsh.sourceforge.io/Doc/Release/Prompt-Expansion.html#Conditional-Substrings-in-Prompts
function prompt_apple() {
  p10k segment -t '%(?.🍏.🍎)'
}
...
() {
  ...
  # See https://stackoverflow.com/a/49752003
